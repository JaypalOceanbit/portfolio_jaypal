        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building clean, scalable web applications with Laravel and
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing native iOS apps with Swift and SwiftUI, focused
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">iOS Swift</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
