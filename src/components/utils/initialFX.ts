...
import { resumeSmoother } from "../Navbar";
...
export function initialFX() {
  ...
  gsap.fromTo(
    ...
    { opacity: 1, duration: 1.2, filter: "blur(0px)", ease: "power3.inOut", y: 0, stagger: 0.05, delay: 0.3 }
  );

  gsap.fromTo(
    ".landing-h2-info",
    { opacity: 0, y: 80, filter: "blur(5px)" },
    { opacity: 1, duration: 1.2, filter: "blur(0px)", ease: "power3.inOut", y: 0, delay: 0.3 }
  );
